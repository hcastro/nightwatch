module.exports = new (function() {
  ...
  /**
   * Adds page-specific custom assertions to the page object
   *
   * @param {Page} parent The page object instance
   * @param {object} command Array of commands that will be added to the page
   * @returns {null}
   */
  this.addAssertions = function(parent, assertions) {
    assertions.forEach(function(m) {
      Object.keys(m).forEach(function(k) {
        // binds the assertion methods to the page object context for a fluid interface
        parent['assert'][k] = m[k].bind(parent)
      });
    });
