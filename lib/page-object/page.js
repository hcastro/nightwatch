...
function Page(options, commandLoader, api, client) {
  ...
  PageUtils
    ...
    .addAssertions(this, options.assertions || []);

  CommandWrapper.addWrappedCommands(this, this.commandLoader);
  
  if (options.waitUntilReady && typeof options.waitUntilReady === 'function') {
    // page sub-classes should implement this method with any additional waits
    // needed before the page is ready to be interacted with
    options.waitUntilReady.call(this)
  }
}
